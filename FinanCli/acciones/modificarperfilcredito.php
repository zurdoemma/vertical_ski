<?php 		
		...
		echo '						<button type="button" id="verPlanesCreditoV" class="btn" title="'.translate('Msg_View_Credit_Plan_X_Profile',$GLOBALS['lang']).'" onclick="verPlanesCredito(\''.$id_perfil_credito.'\',\''.$nombre_perfil_credito.'\');"><i class="fa fa-eye"></i></button>';
		echo '					</div>';		
		echo '				</div>';		
		echo '				<div class="form-group form-inline">';
