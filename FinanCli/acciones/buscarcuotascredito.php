<?php 		
		...
		echo '						<input class="form-control input-sm" id="montooriginalcuotacreditvi" name="montooriginalcuotacreditvi" type="text" maxlength="11" value="'.round(($montoCuotas/100.00),2).'" disabled/>';
		echo '					</div>';				
		echo '				</div>';
		echo '				<div class="form-group form-inline">';
		...
		echo '						<input class="form-control input-sm" id="interescuotascreditvi" name="interescuotascreditvi" type="text" maxlength="11" value="'.round(($monto_interes_cuota_credito/100.00),2).'" disabled />';
		echo '					</div>';
		...
		echo '						<input class="form-control input-sm" title="'.translate('Msg_A_Total_Amount_Payment_Fee_Credit_Must_Enter',$GLOBALS['lang']).'" id="montototalcuotascreditvi" name="montototalcuotascreditvi" type="text" maxlength="11" value="'.round((($montoCuotas+$monto_interes_cuota_credito)/100.00),2).'" />';
		echo '					</div>';				
		echo '				</div>';
		echo '				<div class="form-group form-inline">';				
