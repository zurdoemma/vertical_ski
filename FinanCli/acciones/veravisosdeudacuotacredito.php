<?php 		
		...
		echo '						<input class="form-control input-sm" id="montocuotaorigv2i" name="montocuotaorigv2i" type="text" maxlength="11" value="'.round(($monto_cuota_orig_db/100.00),2).'" disabled />';
		echo '					</div>';		
		echo '				</div>';		
		echo '				<div class="form-group form-inline">';
		...
		echo '						<input class="form-control input-sm" id="interesescuotacreditv2i" name="interesescuotacreditv2i" type="text" maxlength="11" value="'.round(($montoIntereses/100.00),2).'" disabled />';
		echo '					</div>';
		...
		echo '						<input class="form-control input-sm" id="montototalcuotacreditv2i" name="montototalcuotacreditv2i" type="text" maxlength="11" value="'.round(($montoTotalConInteresesCuotaCredito/100.00),2).'" disabled />';
		echo '					</div>';		
		echo '				</div>';
