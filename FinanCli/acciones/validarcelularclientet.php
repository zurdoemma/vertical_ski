<?php 		
		...
		$resultado_env = envio_sms(translate('Lbl_From_SMS_ID_Sent',$GLOBALS['lang']), $prefijoTelefono.$nroTelefono, translate('Msg_Client_Registration_Phone_Verification_Code',$GLOBALS['lang']).': '.$codigo_validacion_vcc);
