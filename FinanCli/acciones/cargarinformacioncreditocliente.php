<?php 		
		...
		echo translate('Msg_View_Info_Credit_Client_OK',$GLOBALS['lang']).'=::=::'.json_encode($array).'=:=:'.$minimo_entrega_plan_credito_s_db.'=:=:=:'.$montoTotalCredito;
