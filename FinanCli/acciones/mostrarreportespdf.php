<?php 		
		...
		if($stmt61 = $mysqli->prepare("SELECT r.id, r.nombre FROM ".$db_name.".reportes r WHERE r.id = ?"))
		{
		...
		if($id_reporte_db == 4)
		{
			...
			{
				if($stmt47 = $mysqli->prepare("SELECT c.id_titular, c.nombres, c.apellidos FROM ".$db_name.".cliente c WHERE c.tipo_documento = ? AND c.documento = ?"))
				{
			...
			if(empty($id_titular_cliente_db))
			{
				...
				{
					$selectReportID4 = "SELECT s.codigo, s.nombre, AVG(c.monto_credito_original), cli.nombres, cli.apellidos, cli.id_titular, cli.tipo_documento, cli.documento FROM ".$db_name.".credito c, ".$db_name.".credito_cliente cc, ".$db_name.".sucursal s, ".$db_name.".cliente cli WHERE c.id = cc.id_credito AND cli.tipo_documento = cc.tipo_documento AND cli.documento = cc.documento AND cc.id_sucursal = s.id AND c.estado <> ? AND s.id_cadena = ? AND cc.fecha BETWEEN ? AND ? AND s.codigo = ? AND cli.tipo_documento = ? AND cli.documento = ? GROUP BY s.codigo, s.nombre, cli.nombres, cli.apellidos, cli.tipo_documento, cli.documento HAVING AVG(c.monto_credito_original) IS NOT NULL UNION ALL SELECT s.codigo, s.nombre, AVG(c.monto_credito_original), cli.nombres, cli.apellidos, cli.id_titular, cli.tipo_documento, cli.documento FROM ".$db_name.".credito c, ".$db_name.".credito_cliente cc, ".$db_name.".sucursal s, ".$db_name.".cliente cli WHERE c.id = cc.id_credito AND cli.tipo_documento = cc.tipo_documento_adicional AND cli.documento = cc.documento_adicional AND cc.id_sucursal = s.id AND c.estado <> ? AND s.id_cadena = ? AND cc.fecha BETWEEN ? AND ? AND s.codigo = ? AND cli.tipo_documento = ? AND cli.documento = ? GROUP BY s.codigo, s.nombre, cli.nombres, cli.apellidos, cli.tipo_documento, cli.documento HAVING AVG(c.monto_credito_original)";
				}
		...
		if($id_reporte_db == 9)
		{
			...
			if(empty($id_titular_cliente_db))
			{
				if($sucursal != translate('Lbl_All_Selection',$GLOBALS['lang']) && !empty($documentoCli)) 
				{
					$selectReportID4 = "SELECT s.codigo, s.nombre, AVG(c.monto_compra), cli.nombres, cli.apellidos, cli.id_titular, cli.tipo_documento, cli.documento FROM ".$db_name.".credito c, ".$db_name.".credito_cliente cc, ".$db_name.".sucursal s, ".$db_name.".cliente cli WHERE c.id = cc.id_credito AND cli.tipo_documento = cc.tipo_documento AND cli.documento = cc.documento AND cc.id_sucursal = s.id AND c.estado <> ? AND s.id_cadena = ? AND cc.fecha BETWEEN ? AND ? AND s.codigo = ? AND cli.tipo_documento = ? AND cli.documento = ? GROUP BY s.codigo, s.nombre, cli.nombres, cli.apellidos, cli.tipo_documento, cli.documento HAVING AVG(c.monto_compra) IS NOT NULL UNION ALL SELECT s.codigo, s.nombre, AVG(c.monto_compra), cli.nombres, cli.apellidos, cli.id_titular, cli.tipo_documento, cli.documento FROM ".$db_name.".credito c, ".$db_name.".credito_cliente cc, ".$db_name.".sucursal s, ".$db_name.".cliente cli WHERE c.id = cc.id_credito AND cli.tipo_documento = cc.tipo_documento_adicional AND cli.documento = cc.documento_adicional AND cc.id_sucursal = s.id AND c.estado <> ? AND s.id_cadena = ? AND cc.fecha BETWEEN ? AND ? AND s.codigo = ? AND cli.tipo_documento = ? AND cli.documento = ? GROUP BY s.codigo, s.nombre, cli.nombres, cli.apellidos, cli.tipo_documento, cli.documento HAVING AVG(c.monto_compra)";
				}
				else if($sucursal == translate('Lbl_All_Selection',$GLOBALS['lang']) && !empty($documentoCli))
				{
					$selectReportID4 = "SELECT AVG(c.monto_compra), cli.nombres, cli.apellidos, cli.id_titular, cli.tipo_documento, cli.documento FROM ".$db_name.".credito c, ".$db_name.".credito_cliente cc, ".$db_name.".sucursal s, ".$db_name.".cliente cli WHERE c.id = cc.id_credito AND cli.tipo_documento = cc.tipo_documento AND cli.documento = cc.documento AND cc.id_sucursal = s.id AND c.estado <> ? AND s.id_cadena = ? AND cc.fecha BETWEEN ? AND ? AND cli.tipo_documento = ? AND cli.documento = ? GROUP BY cli.nombres, cli.apellidos, cli.tipo_documento, cli.documento HAVING AVG(c.monto_compra) IS NOT NULL UNION ALL SELECT AVG(c.monto_compra), cli.nombres, cli.apellidos, cli.id_titular, cli.tipo_documento, cli.documento FROM ".$db_name.".credito c, ".$db_name.".credito_cliente cc, ".$db_name.".sucursal s, ".$db_name.".cliente cli WHERE c.id = cc.id_credito AND cli.tipo_documento = cc.tipo_documento_adicional AND cli.documento = cc.documento_adicional AND cc.id_sucursal = s.id AND c.estado <> ? AND s.id_cadena = ? AND cc.fecha BETWEEN ? AND ? AND cli.tipo_documento = ? AND cli.documento = ? GROUP BY cli.nombres, cli.apellidos, cli.tipo_documento, cli.documento HAVING AVG(c.monto_compra) IS NOT NULL";
				}
				else if($sucursal != translate('Lbl_All_Selection',$GLOBALS['lang']) && empty($documentoCli)) 
				{
					$selectReportID4 = "SELECT s.codigo, s.nombre, AVG(c.monto_compra), cli.nombres, cli.apellidos, cli.id_titular, cli.tipo_documento, cli.documento FROM ".$db_name.".credito c, ".$db_name.".credito_cliente cc, ".$db_name.".sucursal s, ".$db_name.".cliente cli WHERE c.id = cc.id_credito AND cli.tipo_documento = cc.tipo_documento AND cli.documento = cc.documento AND cc.id_sucursal = s.id AND c.estado <> ? AND s.id_cadena = ? AND cc.fecha BETWEEN ? AND ? AND s.codigo = ? GROUP BY s.codigo, s.nombre, cli.nombres, cli.apellidos, cli.tipo_documento, cli.documento HAVING AVG(c.monto_compra) IS NOT NULL UNION ALL SELECT s.codigo, s.nombre, AVG(c.monto_compra), cli.nombres, cli.apellidos, cli.id_titular, cli.tipo_documento, cli.documento FROM ".$db_name.".credito c, ".$db_name.".credito_cliente cc, ".$db_name.".sucursal s, ".$db_name.".cliente cli WHERE c.id = cc.id_credito AND cli.tipo_documento = cc.tipo_documento_adicional AND cli.documento = cc.documento_adicional AND cc.id_sucursal = s.id AND c.estado <> ? AND s.id_cadena = ? AND cc.fecha BETWEEN ? AND ? AND s.codigo = ? GROUP BY s.codigo, s.nombre, cli.nombres, cli.apellidos, cli.tipo_documento, cli.documento HAVING AVG(c.monto_compra) IS NOT NULL";
			...
			{
				if($sucursal != translate('Lbl_All_Selection',$GLOBALS['lang']) && !empty($documentoCli)) $selectReportID4 = "SELECT s.codigo, s.nombre, AVG(c.monto_compra), cli.nombres, cli.apellidos, cli.id_titular, cli.tipo_documento, cli.documento FROM ".$db_name.".credito c, ".$db_name.".credito_cliente cc, ".$db_name.".sucursal s, ".$db_name.".cliente cli WHERE c.id = cc.id_credito AND cli.tipo_documento = cc.tipo_documento_adicional AND cli.documento = cc.documento_adicional AND cc.id_sucursal = s.id AND c.estado <> ? AND s.id_cadena = ? AND cc.fecha BETWEEN ? AND ? AND s.codigo = ? AND cli.tipo_documento = ? AND cli.documento = ? GROUP BY s.codigo, s.nombre, cli.nombres, cli.apellidos HAVING AVG(c.monto_compra) IS NOT NULL";
				else if($sucursal == translate('Lbl_All_Selection',$GLOBALS['lang']) && !empty($documentoCli)) $selectReportID4 = "SELECT AVG(c.monto_compra), cli.nombres, cli.apellidos, cli.id_titular, cli.tipo_documento, cli.documento FROM ".$db_name.".credito c, ".$db_name.".credito_cliente cc, ".$db_name.".sucursal s, ".$db_name.".cliente cli WHERE c.id = cc.id_credito AND cli.tipo_documento = cc.tipo_documento_adicional AND cli.documento = cc.documento_adicional AND cc.id_sucursal = s.id AND c.estado <> ? AND s.id_cadena = ? AND cc.fecha BETWEEN ? AND ? AND cli.tipo_documento = ? AND cli.documento = ? GROUP BY cli.nombres, cli.apellidos HAVING AVG(c.monto_compra) IS NOT NULL";
				else if($sucursal != translate('Lbl_All_Selection',$GLOBALS['lang']) && empty($documentoCli)) $selectReportID4 = "SELECT s.codigo, s.nombre, AVG(c.monto_compra), cli.nombres, cli.apellidos, cli.id_titular, cli.tipo_documento, cli.documento FROM ".$db_name.".credito c, ".$db_name.".credito_cliente cc, ".$db_name.".sucursal s, ".$db_name.".cliente cli WHERE c.id = cc.id_credito AND cli.tipo_documento = cc.tipo_documento_adicional AND cli.documento = cc.documento_adicional AND cc.id_sucursal = s.id AND c.estado <> ? AND s.id_cadena = ? AND cc.fecha BETWEEN ? AND ? AND s.codigo = ? GROUP BY s.codigo, s.nombre, cli.nombres, cli.apellidos HAVING AVG(c.monto_compra) IS NOT NULL";
				else $selectReportID4 = "SELECT AVG(c.monto_compra), cli.nombres, cli.apellidos, cli.id_titular, cli.tipo_documento, cli.documento FROM ".$db_name.".credito c, ".$db_name.".credito_cliente cc, ".$db_name.".sucursal s, ".$db_name.".cliente cli WHERE c.id = cc.id_credito AND cli.tipo_documento = cc.tipo_documento_adicional AND cli.documento = cc.documento_adicional AND cc.id_sucursal = s.id AND c.estado <> ? AND s.id_cadena = ? AND cc.fecha BETWEEN ? AND ? GROUP BY cli.nombres, cli.apellidos HAVING AVG(c.monto_compra) IS NOT NULL";				
			}
		...
		if($id_reporte_db == 10)
		{
			...
			if($sucursal != translate('Lbl_All_Selection',$GLOBALS['lang'])) $selectReportID10 = "SELECT s.codigo, s.nombre, COUNT(es.id) FROM ".$db_name.".credito c, ".$db_name.".credito_cliente cc, ".$db_name.".sucursal s, ".$db_name.".aviso_x_mora axm, ".$db_name.".envio_sms es WHERE axm.id = es.id_aviso_x_mora AND axm.id_credito = c.id AND c.id = cc.id_credito AND cc.id_sucursal = s.id AND s.id_cadena = ? AND es.fecha BETWEEN ? AND ? AND s.codigo = ? GROUP BY s.codigo, s.nombre HAVING COUNT(es.id) IS NOT NULL";
			...
			if ($stmt = $mysqli->prepare($selectReportID10)) 
			{
				...
				if($sucursal != translate('Lbl_All_Selection',$GLOBALS['lang'])) $selectReportID10o2 = "SELECT s.codigo, s.nombre, COUNT(tvc.id) FROM ".$db_name.".sucursal s, ".$db_name.".token_validacion_celular tvc, ".$db_name.".usuario u WHERE tvc.usuario = u.id AND u.id_sucursal = s.id AND s.id_cadena = ? AND tvc.fecha BETWEEN ? AND ? AND s.codigo = ? GROUP BY s.codigo, s.nombre HAVING COUNT(tvc.id) IS NOT NULL";
				else $selectReportID10o2 = "SELECT cad.nombre_fantasia, COUNT(tvc.id) FROM ".$db_name.".sucursal s, ".$db_name.".token_validacion_celular tvc, ".$db_name.".usuario u, ".$db_name.".cadena cad WHERE tvc.usuario = u.id AND u.id_sucursal = s.id AND cad.id = s.id_cadena AND cad.id = ? AND tvc.fecha BETWEEN ? AND ? GROUP BY cad.nombre_fantasia HAVING COUNT(tvc.id) IS NOT NULL";				
		...
		if($id_reporte_db == 11)
		{
			...
			if($sucursal != translate('Lbl_All_Selection',$GLOBALS['lang'])) $selectReportID11 = "SELECT s.codigo, s.nombre, COUNT(cef.id) FROM ".$db_name.".sucursal s, ".$db_name.".consulta_estado_financiero cef WHERE cef.id_cadena = s.id_cadena AND s.id_cadena = ? AND cef.fecha BETWEEN ? AND ? AND s.codigo = ? GROUP BY s.codigo, s.nombre HAVING COUNT(cef.id) IS NOT NULL";
			else $selectReportID11 = "SELECT cad.nombre_fantasia, COUNT(cef.id) FROM ".$db_name.".consulta_estado_financiero cef, ".$db_name.".cadena cad WHERE cef.id_cadena = cad.id AND cad.id = ? AND cef.fecha BETWEEN ? AND ? GROUP BY cad.nombre_fantasia HAVING COUNT(cef.id) IS NOT NULL";
		...
		if($id_reporte_db == 10)
		{
			...
			{				
				...
				while($stmt->fetch()) 
				{
					...
					$selectReportID10o2 = "SELECT s.codigo, s.nombre, COUNT(tvc.id) FROM ".$db_name.".sucursal s, ".$db_name.".token_validacion_celular tvc, ".$db_name.".usuario u WHERE tvc.usuario = u.id AND u.id_sucursal = s.id AND s.id_cadena = ? AND tvc.fecha BETWEEN ? AND ? AND s.codigo = ? GROUP BY s.codigo, s.nombre HAVING COUNT(tvc.id) IS NOT NULL";
					if ($stmto2 = $mysqli->prepare($selectReportID10o2)) 
					{
			...
			{				
				...
				while($stmt->fetch()) 
				{
					...
					$selectReportID10o2 = "SELECT cad.nombre_fantasia, COUNT(tvc.id) FROM ".$db_name.".sucursal s, ".$db_name.".token_validacion_celular tvc, ".$db_name.".usuario u, ".$db_name.".cadena cad WHERE tvc.usuario = u.id AND u.id_sucursal = s.id AND cad.id = s.id_cadena AND cad.nombre_fantasia = ? AND tvc.fecha BETWEEN ? AND ? GROUP BY cad.nombre_fantasia HAVING COUNT(tvc.id) IS NOT NULL";				
					if ($stmto2 = $mysqli->prepare($selectReportID10o2)) 
					{
