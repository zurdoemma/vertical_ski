<?php 		
		...
		echo '						<input class="form-control input-sm" id="montocuotaorigvi" name="montocuotaorigvi" type="text" maxlength="11" value="'.round(($monto_cuota_orig_db/100.00),2).'" disabled />';
		echo '					</div>';		
		echo '				</div>';		
		echo '				<div class="form-group form-inline">';
		...
		echo '						<input class="form-control input-sm" id="interesescuotacreditvi" name="interesescuotacreditvi" type="text" maxlength="11" value="'.round(($montoIntereses/100.00),2).'" disabled />';
		echo '					</div>';
		...
		echo '						<input class="form-control input-sm" id="montototalcuotacreditvi" name="montototalcuotacreditvi" type="text" maxlength="11" value="'.round(($montoTotalConInteresesCuotaCredito/100.00),2).'" disabled />';
		echo '					</div>';		
		echo '				</div>';
