...
<head>
	...
	<script type="text/javascript">
		...
		{
			var urlnu = "./acciones/nuevousuariosup.php";
	...
	<script type="text/javascript">
		...
		{
			var urla = "./acciones/modificarusuariosup.php";
	...
	<script type="text/javascript">
		function guardarNuevoUsuario(formulariod)
		{
			...
			if($('#perfiluserni').val() == 2)
			{
				if($( "#horarioingresouserni" ).val().length == 0)
				{
					$('#horarioingresouserni').prop('title', '<?php echo translate('Msg_You_Must_Enter_The_User_Entry_Time',$GLOBALS['lang']);?>');				
					$(function() {
						$( "#horarioingresouserni" ).tooltip({
						   position: {
							  my: "center bottom",
							  at: "center top-10",
							  collision: "none"
				...
				else 
				{
					...
					$( "#horarioingresouserni" ).tooltip('destroy');
				}
				
				if($( "#horarioegresouserni" ).val().length == 0)
				{
					$('#horarioegresouserni').prop('title', '<?php echo translate('Msg_You_Must_Enter_The_User_Departure_Time',$GLOBALS['lang']);?>');				
					$(function() {
						$( "#horarioegresouserni" ).tooltip({
						   position: {
							  my: "center bottom",
							  at: "center top-10",
							  collision: "none"
	...
	<script type="text/javascript">
		...
		{
			var urla = "./acciones/deshabilitarusuariosup.php";
			$('#img_loader').show();
