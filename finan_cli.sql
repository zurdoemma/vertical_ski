...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-08-2019 a las 22:07:15
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci AUTO_INCREMENT=797 ;
...
CREATE TABLE IF NOT EXISTS `motivo` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci AUTO_INCREMENT=83 ;
