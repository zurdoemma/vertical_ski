...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-08-2019 a las 19:34:12
...
(29, 3, 150000, 4, 10, 165000, 'Pendiente');
...
(29, '20190826103229', 1, '41443194', 'her', 2, 1, '50443194');
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci AUTO_INCREMENT=915 ;
...
ALTER TABLE `estado_cliente`
  ADD CONSTRAINT `fk_foreign_key_estado_cliente_adicional` FOREIGN KEY (`tipo_documento_adicional`, `documento_adicional`) REFERENCES `cliente` (`tipo_documento`, `documento`),
  ...
  ADD CONSTRAINT `fk_foreign_key_estado_cliente` FOREIGN KEY (`tipo_documento`, `documento`) REFERENCES `cliente` (`tipo_documento`, `documento`);
...
ALTER TABLE `login_attempts`
  ADD CONSTRAINT `login_attempts_ibfk_2` FOREIGN KEY (`usuario`) REFERENCES `usuario` (`id`);
...
ALTER TABLE `token_adicional_cuenta`
  ...
  ADD CONSTRAINT `fk_foreign_key_token_adicional_cuenta` FOREIGN KEY (`tipo_documento`, `documento`) REFERENCES `cliente` (`tipo_documento`, `documento`),
...
ALTER TABLE `token_validacion_celular`
  ADD CONSTRAINT `fk_foreign_key_token_validacion_celular` FOREIGN KEY (`tipo_documento`, `documento`) REFERENCES `cliente` (`tipo_documento`, `documento`),
