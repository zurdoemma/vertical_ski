...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-08-2019 a las 22:14:34
...
CREATE TABLE IF NOT EXISTS `ejecucion_procesos_auto` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=79 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci AUTO_INCREMENT=155 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci AUTO_INCREMENT=902 ;
