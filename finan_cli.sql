...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-08-2019 a las 23:07:26
...
INSERT INTO `credito` (`id`, `cantidad_cuotas`, `monto_compra`, `id_plan_credito`, `interes_fijo_plan_credito`, `monto_credito_original`, `estado`, `abona_primera_cuota`) VALUES
(4, 3, 160000, 4, 10, 176000, 'Pendiente', b'0'),
(27, 3, 63320, 4, 10, 69652, 'Pendiente', b'0'),
(28, 6, 36000, 5, 20, 43200, 'Pendiente', b'0'),
(29, 3, 150000, 4, 10, 165000, 'Pendiente', b'0'),
(30, 3, 200000, 4, 10, 220000, 'Pendiente', b'1');
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci AUTO_INCREMENT=90 ;
...
(79, '20190826160640', 'No hay avisos para procesar!!', 2);
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci AUTO_INCREMENT=958 ;
